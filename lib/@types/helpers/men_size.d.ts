 ...
 */
export declare function convertMenSize(sizeCountry: SizeCountry): MenSizeConverter;
/**
 ...
 */
export declare const getMenSizes: (sizeCountry: SizeCountry) => {
    shirts: DataSizeEntriesMap;
    shoes: DataSizeEntriesMap;
    suits: DataSizeEntriesMap;
};
declare const _default: {
    convertMenSize: typeof convertMenSize;
    getMenSizes: (sizeCountry: SizeCountry) => {
        shirts: DataSizeEntriesMap;
        shoes: DataSizeEntriesMap;
        suits: DataSizeEntriesMap;
    };
